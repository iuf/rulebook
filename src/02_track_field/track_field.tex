...
\begin{itemize}
\item For 700c wheels, the rim may not have a bead seat diameter (BSD) larger than 622mm (700c).
...
If the rider is allowed to do a second attempt and decides to do so, the first run is cancelled and only the second run counts regardless of the result.
