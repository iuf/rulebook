...
The timer is started when any defined point of the tire (for example the part that crosses a low light beam) crosses the start line, and stops when a similar point of the tire crosses the finish line or, if the rider did not start in time after the 3 seconds, giving the rider still the chance to ride the course.
