...
\begin{framed}
Venue requirements go here. Does a road race need to be on pavement? Do roads need to be closed to other traffic? How far can it be from Unicon headquarters?
\end{framed}

\section{Officials}

\begin{framed}
Does the IUF require particular officials for these events? The following list is a start at defining officials:
\end{framed}
...
\item Timer
\item Recorder
\item Check-In Official (not currently defined)
\end{itemize}}
...
\textbf{Some thoughts on additional required communication:
\begin{itemize}
...
\framebox{3.2}
Riders can be divided by age and/or unicycle type, such as 24$"$ and 29$"$
