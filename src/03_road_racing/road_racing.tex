...
Riders can be divided by age and/or unicycle type, such as 24$"$ and 700c track unicycles, Standard (any size wheel and cranks), and Unlimited (see definition in chapter \ref{chap:general_definitions}).
...
As an alternative a -tart-beep apparatus can be used.
...
\section{Repair, Change, or Replace a (Broken) Unicycle}
During a Road Race, the rider is allowed to make any change to their unicycle, provided that the rider is self sufficient in this.
This means the rider must have the new parts and tools with.
(For example, a rider can change crank length but must carry the new cranks and required tools with, and perform the change him/herself.)

The rider can only use outside assistance to repair or change their unicycle if it is accidentally broken during the course of the race.
...
It is the role of the Chief Referee to determine if ``accidental breakage'' applies.
If the Chief Referee determines this not to be the case and the rider used outside assistance in changing the unicycle, then the rider will be disqualified.

In any case where a unicycle is changed during a race, it must still conform to the requirements of the category that the rider is entered in.
