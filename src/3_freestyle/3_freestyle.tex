\chapter{Freestyle and Standard Skills}
...
\section{Freestyle, Flatland, and Street Comp Judging Panel}
...
\subsection{Pairs Freestyle: Quantity of Unicycling Skills and Transitions}
...
Duration can be increased if a rider pulls or pushes another rider with holding hands, but will decrease the score as related to Quantity (4.3.1).
...
\subsection{Artistic Director}
The head organizer and administrator of artistic events.
...
Like the Referee, the Chief Judge should be a thoroughly experienced person who must above all be objective and favor neither local, nor outside riders.
...
\subsection{Timer}
The Timer keeps the time for all performances, and makes acoustic signals at key points in performances.

\subsection{Judge}
The Judge rates the performances.
...
The Tabulator processes all judging sheets and fills out final results sheets and other forms.

\subsection{Runner}
The Runner is a general helper who transfers forms and other information from one place to another.

\subsection{Announcer} 
The Announcer operates sound system with DJ, and announces all upcoming riders and results of competitions.
May also provide color commentary between performances.

\subsection{DJ}
The DJ operates sound system, plays all performance music, and keeps track of riders’ music media and any special instructions.

\subsection{Rider Liason}
The Rider Liason checks in riders before they compete.
Determines performing order.
Makes sure riders’ music is properly marked and is otherwise prepared.

\subsection{Stage Crew}The Stage Crew helps riders set up, tear down, and clean up after themselves.

\subsection{Results Poster}
The Results Poster puts up artistic results sheets for all to see, and marks the time.