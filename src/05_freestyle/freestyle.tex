...
\newpage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Judging Grids %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Judging Grid: Technical Scores}
...
% \newpage
% \section{Judging Grid: Performance Scores}
% \begingroup
%     \fontsize{7pt}{9pt}\selectfont
% \setlength{\LTleft}{-2.5cm}
...
\subsection{Wave ($\sim$) = -0.5 Point} %or \textasciitilde
