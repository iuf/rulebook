...
Final Dismount Score $= 10 \cdot -$ mistake score/number of riders.
...
\textbf{Mastery and Quality of Execution (weighted 1.5x)} &
\textbf{Difficulty and Duration (weighted 1.5x)} \\
\hline
10.00--9.00 \newline
\emph{Outstanding} &

\begin{judging_items}%column 2
\item no room to add more skills
\item impressive originality
\end{judging_items} &

\begin{judging_items}%column 3
\item no room to improve
\item never loss of control
\item all criteria are perfect
\end{judging_items} &

\begin{judging_items}%column 4
\item all very difficult skills
...
\begin{judging_items}%column 3
\item almost all criteria are perfect without loss of control
\end{judging_items} &

\begin{judging_items}%column 4
\item almost all skills are at high difficulty
\item skills enough duration
\end{judging_items} \\
\hline
...
\begin{judging_items}%column 2
\item filled with many skills
\item proper pause and variations
\item some originality
\end{judging_items} &

\begin{judging_items}%column 3
\item excellent Mastery and Quality but some loss of control
\end{judging_items} &

\begin{judging_items}%column 4
\item many skills at high difficulty
\item some skills with short durations
\end{judging_items} \\
\hline
...
\begin{judging_items}%column 2
\item average number of skills and variations
\end{judging_items} &

\begin{judging_items}%column 3
\item all criteria are average level
\end{judging_items} &

\begin{judging_items}%column 4
\item generally average or higher difficulty
\item some skills with short duration
\end{judging_items} \\
\hline
...
\begin{judging_items}%column 4
\item generally lower than average or higher difficulty 
\item many skills with short duration
\end{judging_items} \\
\hline
...
\begin{judging_items}%column 2
\item lower number of skills without proper variations
\end{judging_items} &

\begin{judging_items}%column 3
\item all criteria are lower than average
\end{judging_items} &

\begin{judging_items}%column 4
\item only one or two skills at high level
\item all skills with short duration
\end{judging_items} \\
\hline
...
\begin{judging_items}%column 2
\item no unicycling skills
\end{judging_items} &

\begin{judging_items}%column 3
\item none of the criteria are followed
\end{judging_items} &
\item looks like will fall constantly
\item much repetition of skills
