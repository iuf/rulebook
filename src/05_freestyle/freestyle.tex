...
\begin{judging_items}[leftmargin=*]%column 2

\end{judging_items} &

\begin{judging_items}[leftmargin=*]%column 3
 
\end{judging_items} &

\begin{judging_items}[leftmargin=*]%column 4
...
\item choreography gives the feeling of a halfly unified dance
\end{judging_items} &
