...
\multirow{3}{*}{almost all movements are precise and intentional} &
\multirow{3}{*}{rider uses a variety of dispositions and expressions in a way that engages the audience} &
strong projection \\
\cline{1-4} \cline{7-7}
...
5.00--5.99 \newline \emph{Average} &
\multirow{2}{*}{average involvement or involvement in one or two ways} &
average carriage/lines with some breaks &
\multirow{2}{*}{average authenticity, there are moments when the rider is out of character} &
\multirow{3}{*}{average clarity, some movements look precise while others look unintentional} &
\multirow{2}{*}{average level of creativity with disposition and expression} &
...
3.00--3.99 \newline \emph{Weak} &
\multirow{2}{*}{occasional presence shown, eyes often downcast} &
variable line of body and limbs/carriage/extensions &
\multirow{2}{*}{the rider is occasionally in character} &
&
\multirow{2}{*}{some variety with expression and disposition but rider often looks the same throughout the routine} &
...
&
\multirow{2}{*}{very poor clarity, few to no moves look intentional} &
&
...
\multirow{2}{*}{choreography gives the feeling of a mostly unified dance} &
excellent use of space & change of tempo incorporated with ease &
\multirow{2}{*}{great creativity in the creation of the routine} \\
\cline{1-2} \cline{4-5}
...
\multirow{2}{*}{interesting composition that creates a routine that feels unified most of the time} &
...
\multirow{3}{*}{variable changes in tempo} &
average amount of creativity and imagination used when creating routine \\
\cline{1-4} \cline{6-6}

4.00--4.99 \newline \emph{Fair} &
routine correspondents well with concept &
\multirow{2}{*}{choreography gives the feeling of a halfway unified dance} &
\multirow{3}{*}{elements generally well distributed but sometimes too much emphasis to one part of the performance space} &
&
\multirow{2}{*}{some creativity and imagination used when creating this routine} \\
\cline{1-2}
...
\multirow{2}{*}{placement of moves lacks coherence} &
&
\multirow{2}{*}{few changes in tempo} &
\multirow{2}{*}{a small amount of creativity and imagination was used to create this routine} \\
\cline{1-2} \cline{4-4}

1.00--1.99 \newline \emph{Very Poor} &
many moves do not appear to fit concept &
&
\multirow{2}{*}{poor variety of placement of moves in the performance space} &
&
 \\
\cline{1-3} \cline{5-6}
...
8.00--8.99 \newline \emph{Very Good} &
&
\multirow{8}{*}{\begin{tabular}[c]{@{}c@{}}\textasciicircum \\ |\\ |\\ |\\ \\ \\ \\ \\ \\ |\\ |\\ |\\ \/\end{tabular}} &
\multirow{8}{*}{\begin{tabular}[c]{@{}c@{}}\textasciicircum \\ |\\ |\\ |\\ \\ \\ \\ \\ \\ |\\ |\\ |\\ \/\end{tabular}} &
\multirow{8}{*}{\begin{tabular}[c]{@{}c@{}}\textasciicircum \\ |\\ |\\ |\\ \\ \\ \\ \\ \\ |\\ |\\ |\\ \/\end{tabular}} \\
\cline{1-2}
