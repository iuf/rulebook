...
\textbf{Props} are all items which are used by the rider in his/her performance and require a technical handling by the rider (for example typical objects from Rhythmic gymnastics, like clubs, ribbons, hoop, etc.). 
