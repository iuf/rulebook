\chapter{Skill Levels \label{chap:skill}}
...
For any skill description and clarification not listed here, refer to the IUF Standard Skill rules (in chapter \ref{chap:freestyle}) and the Standard Skills List (section \ref{sec:freestyle_std-skills-list}).
