...
\setcounter{tocdepth}{2} %  includes sections and subsections in TOC
...
\setcounter{part}{1}
\singlechapter{IUF Skill Levels \label{chap:skill}}
...
\item Be able to understand all rules stated on the skill level card as well as in the IUF Official Rulebook.
\end{itemize}
...
By signing this document, the potential tester agrees to all rules and responsibilities presented in this document.
...
\item Follow completely and accurately all rules and guidelines presented here and in the IUF List of Standard Skills.
...
Any Official Skill Level Tester from any country may test levels, as long as the guidelines highlighted in this document are accurately followed.
...
For any skill description and clarification not listed here, refer to the IUF Standard Skill rules and the Standard Skill List.
...
\begin{figure}[h]
\begin{center}
\includegraphics{../img/degree_turns}
\end{center}
\vspace{-20pt}
\vspace{-10pt}
\end{figure}
...
Definitions for these mounts can be found in the IUF List of Standard Skills.
