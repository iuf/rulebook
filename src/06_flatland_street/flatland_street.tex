...
Hosts must publicize the dimensions of the available performing area as far in advance of the competition as possible, and organizers of international championships at least three months prior to the event. See Flatland Overveiw (section \ref{flat-street_flatland-overview}) and Street Overveiw (section \ref{flat-street_street-overview}) for details on performing areas.
...
\section{Flatland Overview \label{flat-street_flatland-overview}}
...
These semifinal and final battles can last between 2 and 4 minutes, to be agreed upon by both riders.
...
At the conclusion of each battle and preliminary run, the rider(s) will have 3 attempts to perform a final trick.
Only the last attempt will be scored.
The rider is not obligated to try the same trick in every attempt. A final trick can not last longer than 15 seconds to complete.
...
\section{Street Overview \label{flat-street_street-overview}}
