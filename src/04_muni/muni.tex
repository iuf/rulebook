...
For all muni events, riders must wear shoes, kneepads, gloves/wristguards and helmets (definitions, Section 1.2.6). %TODO: update reference 
...
Unless otherwise noted, non-lane passing rules apply (see Section 2.7.1). %TODO: update reference 
...
Riders must also ride completely across the finish line, as described in Section 2.6.%TODO: update reference
