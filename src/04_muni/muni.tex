...
Unless otherwise noted, non-lane passing rules apply (see section \ref{subsec:track_field_lane-use_non-lane-races}).
...
Riders must also ride completely across the finish line, as described in section \ref{sec:track_field_finishes}.
