\documentclass[a4paper,oneside,parskip=half,numbers=noenddot, toc=allwithdot]{scrbook}
...
\usepackage{pict2e}
\usepackage{tikz}
\usetikzlibrary{calc, shapes, arrows, decorations.pathreplacing, positioning, quotes}
