...
\section{Alternate, Optional or Fun Events}
...
Riders’ coasting distances are measured from a ‘starting line’ with a 5 meter minimum, which will be marked by a 'qualifying line.' If the rider does not cross the qualifying line it will count as a failed attempt.
...
\section{Mountain Unicycling (MUni)}
