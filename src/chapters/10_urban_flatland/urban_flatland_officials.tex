...
\begin{framed}
This and the next section were based on text from Chapter 1, reworded to make it specific to flatland.
\end{framed}

\textbf{The Flatland Director is the head organizer and administrator of the flatland
competition.  With the Convention Host, the Flatland Director determines the system used to run the event.
The Flatland Director is responsible for the logistics and
equipment for all flatland events.  With the Chief Judge, the
Flatland Director is in charge of keeping events running on schedule, and
answers all questions not pertaining to rules and judging.  The Flatland
Director is the highest authority on everything to do with the flatland
competition, except for decisions on rules and results.}

\section{Chief Judge}

\textbf{The Chief Judge is the head flatland official, whose primary job is to make sure the rules are followed. The Chief Judge oversees the competition, deals with protests, and answers all rules and judging questions.
...
\oldrule{7.10}The Chief Judge must resolve all protests within 30 minutes from receipt of the written form.
...
\oldrule{7.11}
\textit{For Flatland, there must always be an odd number of judges.}

\begin{framed}
We can eliminate the above duplicate rule.
\end{framed}
...
The eliminations must be agreed upon by the Chief Judge and \textit{Artistic}\textbf{Flatland} Director, or next-highest ranking street official if the Chief Judge and \textit{Artistic}\textbf{Flatland} Director are the same person.
...
\oldrule{7.23.3}
\textit{Battles are judged using the same criteria as the preliminary round.}

\textbf{Preliminary rounds and battles are judged using the following criteria:}
...
\oldrule{7.23.3.1}
\textit{The two competitors who make it to the last battle compete for 1st and 2nd place in the Finals.
...
\textbf{The winner and loser of the final battle round take first and second place in the competition. The losers of the semi-final battle round compete in a final battle for third place.}
...
\textbf{For each rider, t}he highest and lowest scores are removed.
...
\textit{Once place 1-8 is figured out, the battles can be configured like described in section \ref{subsec:flat-street_flatland-judging-scoring_battle}.}
