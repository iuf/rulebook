...
\begin{framed}
Is this really true that riders can still bring their own music? The rule should probably state that the host/DJ provides the music for the flatland competition.
\end{framed}
...
\oldrule{7.6}
Riders who are not ready at their scheduled \textit{performance}\textbf{competition} time may or may not be allowed to perform after the last competitor in their age group.
...
\begin{framed}
This is not accurate.  It needs to mention the last trick.
\end{framed}
...
\oldrule{7.20}
In a Flatland battle, \textbf{two} riders compete head-to-head \textit{in groups of two}, taking turns performing lines of tricks.
