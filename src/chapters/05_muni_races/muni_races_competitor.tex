...
\section{Safety}
\oldrule{5.3}
For all muni events, riders must wear shoes, kneepads, gloves/wrist-guards and helmets (see definitions in chapter \ref{chap:general_definitions}). Additional equipment such as shin, elbow or ankle protection are optional.
...
\textit{The following penalties apply if riders disregard this: %scott why does mary want to remove this?
\begin{itemize}
