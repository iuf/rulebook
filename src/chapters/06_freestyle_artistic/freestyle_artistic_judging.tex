...
These subcategories are weighted by a factor as follows:

\begin{tabular}{l l l}
 & Quantity of Unicycling Skills And Transitions & factor: 1 \\
 & Mastery And Quality of Execution & factor: 1 \\
 & Difficulty And Duration & factor: 1 \\
\end{tabular}
...
If the `top' rider does not display much unicycling skill when riding, judges must keep that in mind, and rate their average difficulty accordingly.
...
\begin{tabular}{l l l}
 & Presence/Execution & factor: 1 \\
 & Composition/Choreography & factor: 1 \\
 & Interpretation of the Music/Timing & factor: 1 \\
\end{tabular}\\
