...
Other events (eg. Newcomer Freestyle events that welcome first timers) can allow shorter durations to lower the entrance barrier for first timers.
The maximum routine length must be announced with tender/bidding for each event.
