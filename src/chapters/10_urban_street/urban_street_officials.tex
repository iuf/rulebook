...
For each judging category, judges will assign 0 to 10 points.
These categories are combined with the following weights to create a run score out of 100 points:\\
Difficulty 35\%: average difficulty of all landed tricks\\
Variety 25\%: average variety of all landed tricks\\
Fullness 20\%: how much time of the run was used for riding street.
Deduction of points for wandering around without doing any tricks and for failing tricks.\\
