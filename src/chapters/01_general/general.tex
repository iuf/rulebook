...
Age groups for events at the start of registration will follow their event rules.
Hosts are allowed to expand (add) or compress (remove) age groups if allowed by the event rules.
Age group changes must be published.
