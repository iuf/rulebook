...
\begin{enumerate}[leftmargin=1.5em,labelsep=*]
	...
	\begin{enumerate}[label=\Roman*,leftmargin=1.75em,labelsep=0.5em]
		\item Junior (<14)
		\item Senior (15+)
	\end{enumerate}
	\item Classes can never be merged.
	Organizers may choose to only offer competitions in one of the classes, but if they allow competitors of both classes, they need to be separate.
\end{enumerate}
