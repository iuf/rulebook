...
\section{Other Uses for These Rules}
...
\oldrule{1.9}
The host should ensure that the competitions conditions are conducted and recorded according to the IUF Rulebook and the IUF World Record standards.
...
\begin{itemize}
  ...
  \item Field events: Long Jump, High Jump, Gliding/Coasting. See part \ref{part:jumps} and sections \ref{sec:track-field_coasting-events}/\ref{sec:track-field_gliding-events}.
...
\section{Age Groups}\label{subsec:general_host's-option-unicon_combining-age-groups}}
...
\subsection{Photography and Videography}
\oldrule{1.5}
...
\textbf{Shoes:} 
\begin{framed}
This was renamed to ``shoes'' and moved to its new location.
\end{framed}
