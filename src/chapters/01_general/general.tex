...
\begin{framed}
The following came from the old flatland/street chapter.
\end{framed}
...
\begin{itemize}
  ...
  \item Field events: Long Jump, High Jump, Gliding/Coasting. See chapter \ref{part:jumps} and sections \ref{sec:track-field_coasting-events}/\ref{sec:track-field_gliding-events}.
...
\begin{framed}
This section does not really contain any rules, and should be deleted.
\end{framed}
...
\begin{framed}
There are errors in this that will need to be addressed, later.
\end{framed}
