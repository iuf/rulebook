...
A free distance race can be any race distance that is more than 3\% different from the distance of any recognized fixed distance race.
...
A more accurate method is also allowed.
\begin{enumerate}
...
Using a more accurate measurement is also allowed, such as the method described for `Fixed Distance Races'.
