...
\textbf{The host must designate the following officials for street:
\begin{itemize}
...
\begin{framed}
Is it true that there is no requirement for age groups?
\end{framed}

\textbf{There are no mimimum age groups.}
