...
In the case where a traditional race distance is used (such as 10k, Marathon -- 42.195k, or 100k), the course must be accurately measured along the shortest possible path.
