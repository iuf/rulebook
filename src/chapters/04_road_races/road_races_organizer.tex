...
\oldrule{4.1}
\textit{These are races held usually on roadways or bike paths.}

\textbf{Road races must be held on roadways or paved bike paths.}
...
\textbf{The host must designate the following officials for each road race:
\begin{itemize}
\item Race Director
\item Referee
\item Starter
...
\textit{Convention hosts are free to offer more age groups, and often do.
...
\begin{framed}
Is the host required to offer both unlimited and limted for 10k?
\end{framed}
