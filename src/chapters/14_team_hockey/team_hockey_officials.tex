...
\raisebox{-1\height}{\includegraphics{hockey_foul}}
&
\textbf{``Free shot''}
...
\raisebox{-1\height}{\includegraphics{hockey_washout}}
&
\textbf{``Face-off''}
...
\raisebox{-1\height}{\includegraphics{hockey_6_50m}}
&
\textbf{``6.50 m''}
...
\raisebox{-1\height}{\includegraphics{hockey_nofoul}}
&
\textbf{``No Foul''}
...
\raisebox{-1\height}{\includegraphics{hockey_timeout}}
&
\textbf{``Time out''}
...
\raisebox{-1\height}{\includegraphics{hockey_goal}}
&
\textbf{``Goal''}
...
\raisebox{-1\height}{\includegraphics{hockey_nogoal}}
&
\textbf{``No goal''}
...
\raisebox{-1\height}{\includegraphics{hockey_highstick}}
&
\textbf{``High stick''}
...
\raisebox{-1\height}{\includegraphics{hockey_sub}}
  &
\textbf{``SUB and SIB''}
...
\raisebox{-1\height}{\includegraphics{hockey_obstacle}}
  &
\textbf{``Obstacle''}
...
\raisebox{-1\height}{\includegraphics{hockey_bodycontact}}
  &
\textbf{``Body contact''}
...
\raisebox{-1\height}{\includegraphics{hockey_2_min}}
&
...
\raisebox{-1\height}{\includegraphics{hockey_5_min}}
  &
