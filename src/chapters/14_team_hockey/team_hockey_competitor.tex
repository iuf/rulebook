...
\subsubsection{SUB (Stick Under Bike)}
\oldrule{8.6.3}
...
\subsubsection{SIB (Stick In Bike)}
\oldrule{8.6.4}
...
\subsubsection{Insults}
\oldrule{8.6.5}
A player must not insult the Referee or other players.

\subsubsection{Intentional Fouls \label{subsec:hockey_fouls_intentional-fouls}}
\oldrule{8.6.6}
...
\subsection{Goal Shots}

\subsubsection{Goal Shot With Arms Or Hands \label{subsec:hockey_goal-shots_with-arms-or-hands}}
\oldrule{8.7.1}
...
\subsubsection{Ball In The Outside Of The Net}
\oldrule{8.7.3}
...
\subsubsection{Top Of The Stick}
\oldrule{8.8.2}
...
\subsubsection{The Lower End Of The Stick}
\oldrule{8.8.3}
...
\subsubsection{Exaggerated Roughness}
\oldrule{8.8.4}
