...
\textbf{Alternatively, a start-beep apparatus may be used.  See section \ref{sec:track_starter} for details.}
...
\textbf{False starts will be handled as determined by the host, and as described in section \ref{sec:track_false_starts}.}
