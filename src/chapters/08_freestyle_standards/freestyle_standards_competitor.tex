...
\textit{It is recommended to have one or more backup copies of all music in case of loss or damage.
...
\oldrule{6.7.2}
\textit{Competitors must provide their music in a type that is supported, and has been announced by the Artistic Director.
