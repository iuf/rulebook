...
\begin{framed}
Does the IUF require particular officials for this event?  The following list is a start at defining officials.
\end{framed}
...
\subsection{Assignment of Observers}
\oldrule{7.8}
...
\subsection{Participation By The Course Setter(s)}
\oldrule{7.10}
...
\label{sec:trials_guidelines-for-course-setters}}
