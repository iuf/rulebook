...
\section{Safety}
For all muni events, riders must wear shoes, knee pads, gloves and helmets (see definitions in chapter \ref{chap:general_definitions}).
Additional equipment such as shin, elbow or ankle protection are optional.
Back protector or backpack and full-fingered gloves are recommended for Downhill.
...
Any unicycle may be used (as defined in chapter \ref{chap:general_definitions}).
