...
\oldrule{2.15}
\textit{The official protest form must be available to riders at all times. All protests
...
\oldrule{3.8}To avoid endless competitions, the length to jump will always increase by 5cm for each round.
