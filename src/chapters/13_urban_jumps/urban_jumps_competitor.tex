...
\oldrule{adapted from 2.3}
\textbf{Riders must wear shoes, kneepads, gloves, and helmet.}

\section{Unicycles}

\oldrule{2.19.1.1 and 2.19.2.1}Standard unicycles must be used (see definition in chapter \ref{chap:general_definitions}).
