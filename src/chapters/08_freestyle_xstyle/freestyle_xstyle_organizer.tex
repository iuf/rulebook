...
\section{Age Groups and Classes}

\begin{enumerate}[leftmargin=1.5em,labelsep=*]
	\item There will be no age group scoring. Scoring will only take place in the junior and senior classes in accordance with rule \ref{subsec:general_classes}, even if no titles are awarded.
\end{enumerate}
