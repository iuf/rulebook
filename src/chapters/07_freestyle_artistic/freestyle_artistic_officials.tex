...
For smaller competitions there must be a minimum of three judges each.
...
\subsection{Individual Freestyle -- Dismount Score \label{sec:freestyle_individual-dismount-score}}
...
\textbf{Dismount scores are generated using the following calculation:}
