...
\begin{framed}
We suggest removing the following, because they are more roles than officials.
\end{framed}
...
\oldrule{6.10}
There are five (or more) judges each of Technical and Performance for Age Group competitions; five (or more) judges each of Technical and Performance for Jr. Expert and Expert competitions (including Group).
