...
No rider identification is required. %comment-2016 Can Expert and Jr remove wristbands? Who decides? Or always allowed.
...
%scott the level column doesn't fit here at all. It needs to be moved and explained.
\oldrule{6.4.1}
\begin{tabular}{|l|c|}
\hline
...
When riders sign up with the Rider Liaison they can request ``No acoustic signals.'' This will eliminate the `Start' signal, and the 30-second warning. %comment-2016 "Rider can request this"
...
In all Freestyle routines, an acoustic signal will indicate when there are 30 seconds left. %comment-2016 remove whistle
