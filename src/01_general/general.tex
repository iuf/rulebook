...
Age groups cannot be combined if they conflict with section \ref{subsec:track_field_racing-categories_age-groups} (Age Groups) that specifies minimum age groups for the required races. 
